...
class AddSearchHotwordRequesthotWordsItem {
...
class AddSearchHotwordRequest {
    public $accessToken; // string 接口调用凭证
    public $appKey; // string 小程序唯一标识
    public $hotWords; // array of AddSearchHotwordRequesthotWordsItem 热搜词信息列表
}

/**
 *  array doRequest ($params)
 */
class AddSearchHotword{
    private $data;
    private $errMsg;
    private $response;
    ...
    public function doRequest($params){
        ...
        $client->setPath("/rest/2.0/smartapp/ma/search/hot_word/add");
