...
class GetUnlimitedQrCodeRequest {
...
class GetUnlimitedQrCode{
    ...
    public function doRequest($params){
        ...
        $client->setPath("/rest/2.0/smartapp/qrcode/getunlimitedv2");
        ...
        $client->addPostParam("img_flag",  $params->imgFlag, true);
