...
class ConsumeCouponCodeRequest {
...
class ConsumeCouponCode{
    ...
    public function doRequest($params){
        ...
        $client->setPath("/rest/2.0/smartapp/v1.0/coupon/code/consume");
        ...
        $client->addPostParam("couponTakeId",  $params->couponTakeId);
