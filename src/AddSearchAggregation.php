...
class AddSearchAggregationRequestaggregationsItem {
...
class AddSearchAggregationRequest {
    public $accessToken; // string 接口调用凭证
    public $appKey; // string 小程序唯一标识
    public $mappType; // int64 资源类型，1001-电商，2001-内容
    public $aggregations; // array of AddSearchAggregationRequestaggregationsItem 聚合信息列表
}

/**
 *  array doRequest ($params)
 */
class AddSearchAggregation{
    private $data;
    private $errMsg;
    private $response;
    ...
    public function doRequest($params){
        ...
        $client->setPath("/rest/2.0/smartapp/ma/search/aggregation/add");
