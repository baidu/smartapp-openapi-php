...
class UpdateSearchSynonymRequestsynonymListItem {
...
class UpdateSearchSynonymRequest {
    public $accessToken; // string 接口调用凭证
    public $mappType; // int64 资源类型，1001-电商，2001-内容
    public $synonymList; // array of UpdateSearchSynonymRequestsynonymListItem 同义词信息列表
...
class UpdateSearchSynonym{
    ...
    public function doRequest($params){
        ...
        $client->setPath("/rest/2.0/smartapp/ma/search/synonym/update");
