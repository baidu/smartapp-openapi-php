...
function main(){
    ...
    $params->accessToken = "28.8e486005ce000eb8bf84c115af13ac21.0424338.1653664312.615687-43344823"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->hostName = "baiduboxapp"; // 文档中对应字段：host_name，实际使用时请替换成真实参数
    $params->snid = "ts_article_c803ed3e85ce12117f0407eb"; // 文档中对应字段：snid，实际使用时请替换成真实参数
