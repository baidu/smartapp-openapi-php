...
function main(){
    ...
    $updateOrderSubInfoRequestDataItemEXTSubsOrderItemsItemOrderDetailVal->SwanSchema = "baiduboxapp://swan/B7GF6AWvCSr23myIs13uqaoYz6pPCSY3/wjz/bdxd/order-detail/order-detail?orderId=454546861087"; // 文档中对应字段：SwanSchema，实际使用时请替换成真实参数
    ...
    $updateOrderSubInfoRequestDataItemEXTSubsOrderItemsItemRefundProductItemVal->ID = "158746428688"; // 文档中对应字段：ID，实际使用时请替换成真实参数
    ...
    $updateOrderSubInfoRequestDataItemEXTSubsOrderItemsItemRefundVal->Amount = "1287"; // 文档中对应字段：Amount，实际使用时请替换成真实参数
    ...
    $updateOrderSubInfoRequestDataItemVal->BizAPPID = "WXF2pGOvo5TTGU0qCMMhEjvFBkF6bO0Z"; // 文档中对应字段：BizAPPID，实际使用时请替换成真实参数
    ...
    $updateOrderSubInfoRequestDataItemVal->ResourceID = "1853150832836"; // 文档中对应字段：ResourceID，实际使用时请替换成真实参数
    
    $params = new BaiduSmartapp\OpenapiClient\UpdateOrderSubInfoRequest();
    $params->accessToken = "23.451f85551a2884a3c5ad6c804750eb15.6323347.1425555205.010428-42176400"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->openId = "k34HEREQhWhWWB5WYqYT3ITUGX"; // 文档中对应字段：open_id，实际使用时请替换成真实参数
    $params->sceneId = "1137410026510"; // 文档中对应字段：scene_id，实际使用时请替换成真实参数
    $params->sceneType = 2; // 文档中对应字段：scene_type，实际使用时请替换成真实参数
    $params->pmAppKey = "WXF0pGOvo2TTGU1qCMMhEjvFBkF7bO0Z"; // 文档中对应字段：pm_app_key，实际使用时请替换成真实参数
