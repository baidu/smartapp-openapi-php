...
function main(){
    ...
    $addOrderInfoRequestDataItemEXTMainOrderProductsItemDetailPageVal->SwanSchema = "baiduboxapp://swan/B7GF0AWvCSr14myIs06uqaoYz2pPCSY7/wjz/bdxd/order-detail/order-detail?orderId=582813102061"; // 文档中对应字段：SwanSchema，实际使用时请替换成真实参数
    ...
    $addOrderInfoRequestDataItemEXTMainOrderProductsItemVal->ID = "1558205837700"; // 文档中对应字段：ID，实际使用时请替换成真实参数
    ...
    $addOrderInfoRequestDataItemEXTMainOrderAppraiseVal->SwanSchema = "baiduboxapp://swan/B1GF2AWvCSr51myIs14uqaoYz3pPCSY4/wjz/bdxd/order-detail/order-detail?orderId=743438342050"; // 文档中对应字段：SwanSchema，实际使用时请替换成真实参数
    ...
    $addOrderInfoRequestDataItemEXTMainOrderOrderDetailVal->SwanSchema = "baiduboxapp://swan/B3GF7AWvCSr16myIs61uqaoYz2pPCSY3/wjz/bdxd/order-detail/order-detail?orderId=317648703538"; // 文档中对应字段：SwanSchema，实际使用时请替换成真实参数
    ...
    $addOrderInfoRequestDataItemVal->BizAPPID = "WXF4pGOvo3TTGU1qCMMhEjvFBkF0bO5Z"; // 文档中对应字段：BizAPPID，实际使用时请替换成真实参数
    ...
    $addOrderInfoRequestDataItemVal->ResourceID = "1055532464004"; // 文档中对应字段：ResourceID，实际使用时请替换成真实参数
    ...
    $params->accessToken = "20.511f77745a4031a8c8ad1c430887eb20.6820343.0810368841.426106-20082078"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->openId = "k61HEREQhWhWWB5WYqYT4ITUGX"; // 文档中对应字段：open_id，实际使用时请替换成真实参数
    $params->swanId = ""; // 文档中对应字段：swan_id，实际使用时请替换成真实参数
    $params->sceneId = "1757882812175"; // 文档中对应字段：scene_id，实际使用时请替换成真实参数
