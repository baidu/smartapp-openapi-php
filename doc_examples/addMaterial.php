...
function main(){
    ...
    $params->accessToken = "23.5fa051ebfa7c586dda7b3a677c42237e.7526106.2581667248.168527-66264146"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->appId = 15373515; // 文档中对应字段：app_id，实际使用时请替换成真实参数
    $params->imageUrl = "https://mbs6.bdstatic.com/searchbox/mappconsole/image/81264276/d43d7357-abf0-8d71-a5c2-df4e3b58475b.png"; // 文档中对应字段：imageUrl，实际使用时请替换成真实参数
    ...
    $params->category2Code = "78568"; // 文档中对应字段：category2Code，实际使用时请替换成真实参数
