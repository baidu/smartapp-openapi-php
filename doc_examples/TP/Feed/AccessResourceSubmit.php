...
function main(){
    $obj = new BaiduSmartapp\OpenapiClient\TP\Feed\AccessResourceSubmit();
    // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
    // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
	// 如果开发者不想传非必需参数，可以将设置该参数的行注释
    $params = new BaiduSmartapp\OpenapiClient\TP\Feed\AccessResourceSubmitRequest();
    $params->accessToken = "#token"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->appId = 165; // 文档中对应字段：app_id，实际使用时请替换成真实参数
    ...
    $params->images = "[\"https://b.bdstatic.com/miniapp/resource/image/demo5.png\", \"https://b.bdstatic.com/miniapp/resource/image/demo1.png\"]"; // 文档中对应字段：images，实际使用时请替换成真实参数
    $params->mappSubType = 1741; // 文档中对应字段：mapp_sub_type，实际使用时请替换成真实参数
    $params->mappType = 1810; // 文档中对应字段：mapp_type，实际使用时请替换成真实参数
    $params->path = "/pages/detail/detail?id=504058"; // 文档中对应字段：path，实际使用时请替换成真实参数
