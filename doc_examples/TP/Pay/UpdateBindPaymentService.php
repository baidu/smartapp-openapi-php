...
function main(){
    $obj = new BaiduSmartapp\OpenapiClient\TP\Pay\UpdateBindPaymentService();
    // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
    // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
	// 如果开发者不想传非必需参数，可以将设置该参数的行注释
    $params = new BaiduSmartapp\OpenapiClient\TP\Pay\UpdateBindPaymentServiceRequest();
    $params->accessToken = "#token"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->appName = "智能小程序"; // 文档中对应字段：app_name，实际使用时请替换成真实参数
    $params->servicePhone = "12542112226"; // 文档中对应字段：service_phone，实际使用时请替换成真实参数
    $params->bankAccount = "百度"; // 文档中对应字段：bank_account，实际使用时请替换成真实参数
    $params->bankCard = ""; // 文档中对应字段：bank_card，实际使用时请替换成真实参数
    ...
    $params->poolCashPledge = 148; // 文档中对应字段：pool_cash_pledge，实际使用时请替换成真实参数
    $params->dayMaxFrozenAmount = 16456; // 文档中对应字段：day_max_frozen_amount，实际使用时请替换成真实参数
    $params->bankPhoneNumber = "15105224160"; // 文档中对应字段：bank_phone_number，实际使用时请替换成真实参数
