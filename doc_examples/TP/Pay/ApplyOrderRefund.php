...
function main(){
    $obj = new BaiduSmartapp\OpenapiClient\TP\Pay\ApplyOrderRefund();
    // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
    // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
	// 如果开发者不想传非必需参数，可以将设置该参数的行注释
    $params = new BaiduSmartapp\OpenapiClient\TP\Pay\ApplyOrderRefundRequest();
    $params->accessToken = "#tpToken"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->applyRefundMoney = 181; // 文档中对应字段：applyRefundMoney，实际使用时请替换成真实参数
    $params->bizRefundBatchId = ""; // 文档中对应字段：bizRefundBatchId，实际使用时请替换成真实参数
    $params->isSkipAudit = 1; // 文档中对应字段：isSkipAudit，实际使用时请替换成真实参数
    $params->orderId = 0; // 文档中对应字段：orderId，实际使用时请替换成真实参数
    $params->refundReason = "refund"; // 文档中对应字段：refundReason，实际使用时请替换成真实参数
    ...
    $params->refundNotifyUrl = ""; // 文档中对应字段：refundNotifyUrl，实际使用时请替换成真实参数
