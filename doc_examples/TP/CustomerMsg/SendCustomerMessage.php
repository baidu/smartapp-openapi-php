...
function main(){
    $obj = new BaiduSmartapp\OpenapiClient\TP\CustomerMsg\SendCustomerMessage();
    // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
    // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
	// 如果开发者不想传非必需参数，可以将设置该参数的行注释
    $params = new BaiduSmartapp\OpenapiClient\TP\CustomerMsg\SendCustomerMessageRequest();
    $params->accessToken = "#token"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->userType = 1; // 文档中对应字段：user_type，实际使用时请替换成真实参数
    $params->openId = "#openid"; // 文档中对应字段：open_id，实际使用时请替换成真实参数
    $params->msgType = "text"; // 文档中对应字段：msg_type，实际使用时请替换成真实参数
    $params->content = "content"; // 文档中对应字段：content，实际使用时请替换成真实参数
    $params->picUrl = "https://mbs0.bdstatic.com/searchbox/mappconsole/image/75363047/27feb8a1-d08b-045c-0487-87cfff70c8a2.jpg"; // 文档中对应字段：pic_url，实际使用时请替换成真实参数
