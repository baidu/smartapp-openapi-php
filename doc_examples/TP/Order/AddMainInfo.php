...
function main(){
    $obj = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfo();
    // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
    // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
	// 如果开发者不想传非必需参数，可以将设置该参数的行注释
    $addMainInfoRequestDataItemEXTMainOrderProductsItemSkuAttrItemVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTMainOrderProductsItemSkuAttrItem();
    ...
    $addMainInfoRequestDataItemEXTMainOrderProductsItemVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTMainOrderProductsItem();
    ...
    $addMainInfoRequestDataItemEXTMainOrderPaymentPaymentInfoItemVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTMainOrderPaymentPaymentInfoItem();
    ...
    $addMainInfoRequestDataItemEXTMainOrderPaymentPreferentialInfoItemVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTMainOrderPaymentPreferentialInfoItem();
    ...
    $addMainInfoRequestDataItemEXTMainOrderPaymentVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTMainOrderPayment();
    ...
    $addMainInfoRequestDataItemEXTMainOrderAppraiseVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTMainOrderAppraise();
    ...
    $addMainInfoRequestDataItemEXTMainOrderOrderDetailVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTMainOrderOrderDetail();
    ...
    $addMainInfoRequestDataItemEXTMainOrderVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTMainOrder();
    ...
    $addMainInfoRequestDataItemEXTSubsOrderItemsItemOrderDetailVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTSubsOrderItemsItemOrderDetail();
    ...
    $addMainInfoRequestDataItemEXTSubsOrderItemsItemVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTSubsOrderItemsItem();
    ...
    $addMainInfoRequestDataItemEXTSubsOrderVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXTSubsOrder();
    ...
    $addMainInfoRequestDataItemEXTVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItemEXT();
    ...
    $addMainInfoRequestDataItemVal = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequestDataItem();
    ...
    $params = new BaiduSmartapp\OpenapiClient\TP\Order\AddMainInfoRequest();
    $params->accessToken = "#token"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->openId = "102"; // 文档中对应字段：open_id，实际使用时请替换成真实参数
    $params->sceneId = "173"; // 文档中对应字段：scene_id，实际使用时请替换成真实参数
