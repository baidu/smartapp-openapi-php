...
function main(){
    ...
    $params->accessToken = "21.158f35510a6826a4c4ad2c732164eb76.1224830.2362640671.248542-45088634"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->path = "pages/index/index"; // 文档中对应字段：path，实际使用时请替换成真实参数
    $params->width = 528; // 文档中对应字段：width，实际使用时请替换成真实参数
