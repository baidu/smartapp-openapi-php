...
function main(){
    $obj = new BaiduSmartapp\OpenapiClient\MsgTemplate\SendMsg();
    // 开发者在此设置请求参数，文档示例中的参数均为示例参数，实际参数请参考对应接口的文档上方的参数说明填写
    // 注意：代码示例中的参数字段基本是驼峰形式，而文档中的参数说明的参数字段基本是下划线形式
	// 如果开发者不想传非必需参数，可以将设置该参数的行注释
    $params = new BaiduSmartapp\OpenapiClient\MsgTemplate\SendMsgRequest();
    $params->accessToken = "#token"; // 文档中对应字段：access_token，实际使用时请替换成真实参数
    $params->templateId = "28a24c7d71243cda3a72cad4ffe04660"; // 文档中对应字段：template_id，实际使用时请替换成真实参数
    $params->touserOpenId = ""; // 文档中对应字段：touser_openId，实际使用时请替换成真实参数
    $params->data = "{\"keyword6\": {\"value\": \"order667308\"},\"keyword3\": {\"value\": \"844\"}}"; // 文档中对应字段：data，实际使用时请替换成真实参数
    $params->page = ""; // 文档中对应字段：page，实际使用时请替换成真实参数
    $params->sceneId = "scene035"; // 文档中对应字段：scene_id，实际使用时请替换成真实参数
    $params->sceneType = 1; // 文档中对应字段：scene_type，实际使用时请替换成真实参数
    $params->title = "title107"; // 文档中对应字段：title，实际使用时请替换成真实参数
