<?php
namespace BaiduSmartapp\OpenapiClient\Image;
...
class UploadImageRequest {
    ...
    public $multipartFile; // file 文件
    public $type; // int64 图片用途，1/null：小程序头像；2：服务类目资质图片；3：小程序名称审核资料
}
...
class UploadImage{
    ...
    public function doRequest($params){
        ...
        $client->setPath("/file/2.0/smartapp/upload/image");
