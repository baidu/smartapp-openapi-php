...
class GetAnalysisUserTrendRequest {
    ...
    public $gran; // string 数据粒度：day/hour/week/month
}

/**
 *  array doRequest ($params)
 */
class GetAnalysisUserTrend{
    private $data;
    private $errMsg;
    private $response;
    ...
    public function doRequest($params){
        ...
        $client->setPath("/rest/2.0/smartapp/data/getanalysisusertrend");
